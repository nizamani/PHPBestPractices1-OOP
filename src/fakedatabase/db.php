...
$users = array(
    ...
    array("id" => 2, "name" => "John", "age" => 31, "favoriteRestaurantId" => 2, "favoriteFoodId" => 1),
    array("id" => 2, "name" => "Shehzad", "age" => 30, "favoriteRestaurantId" => 1, "favoriteFoodId" => 1),
    array("id" => 2, "name" => "Paul", "age" => 25, "favoriteRestaurantId" => 2, "favoriteFoodId" => 2)
);
